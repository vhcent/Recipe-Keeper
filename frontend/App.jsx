            ...
            <View style={{
                ...
                <NavigationContainer >
                    <Tab.Navigator screenOptions={{
                        ...
                        tabBarStyle: { height: 90, backgroundColor: "#434343", marginBottom: "4%", paddingTop: "2%" },
                        tabBarActiveBackgroundColor: styles.navbar.backgroundColor,
                        tabBarInactiveBackgroundColor: styles.navbar.backgroundColor,
                        ...
                        <Tab.Screen
                            options={{
                                title: 'Search',
                                tabBarIcon: ({ color, size }) => (<FontAwesome id="search-icon" name="search" size={size} color={color} />),
                            }}
                            name="Search"
                            component={Search}
                        />
                        <Tab.Screen
                            options={{
                                title: 'Grocery',
                                tabBarIcon: ({ color, size }) => (<AntDesign id="cart-icon" name="shoppingcart" size={size} color={color} />)
                            }}
                            name="Grocery"
                        ...
                        <Tab.Screen
                            options={{
                                title: 'Saved',
                                tabBarIcon: ({ color, size }) => (<AntDesign id="heart-icon" name="heart" size={size} color={color} />)
                            }}
                            name="Saved"
                            component={Saved} />
                    </Tab.Navigator>
