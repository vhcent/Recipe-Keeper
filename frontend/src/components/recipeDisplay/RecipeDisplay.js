export async function getRecipeDetails(id) {
    console.log("ID:", id);
    let response = await fetch("https://api.spoonacular.com/recipes/" + id + "/information?apiKey=8d51cf1e41ad42fcb9c2699fbba2cfbd", {
        method: 'GET',
        headers: {
...
export async function getDuplicateList(userID, recipeIDString) {
    ...
    let response = await fetch("https://cmivyuanic.execute-api.us-west-2.amazonaws.com/tentative/checkSaved?userID=auth0|62dedd66ea483987422d888c&IDs=111111,123123,555555,888888", {
        method: 'GET',
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
